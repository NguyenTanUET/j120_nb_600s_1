...
def main():
    ...
    output_file = result_dir / "j120_with_bound_600s_1.csv"
    ...
    local_path = "result/j120_with_bound_600s_1.csv"
    blob_name = f"results/{os.path.basename(local_path)}"  # ví dụ "results/j120_with_bound_600s_1.csv"
